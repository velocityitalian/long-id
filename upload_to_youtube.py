"""
YouTube Upload Script for Velocity Indonesian
"""
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Indonesian with Velocity Indonesian"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Indonesian", "Indonesian Phrases", "Indonesian Language", "Velocity Indonesian", "Indonesian for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY INDONESIAN - YOUTUBE UPLOADER")
