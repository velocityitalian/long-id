...
SCENIC_STYLES = [
    "stunning Indonesian woman in traditional batik, Bali rice terraces, sunset",
    "elegant Javanese woman in kebaya, Borobudur temple, golden morning light",
    "beautiful Indonesian woman in traditional attire, Jakarta skyline, modern cityscape",
    "Indonesian girl at Bali beach, Uluwatu cliffs, golden hour",
    "gorgeous Indonesian woman in traditional songket, Lake Toba, serene waters",
    "beautiful Indonesian woman, Prambanan temple, warm sunset light",
    "Indonesian woman in traditional kebaya, Yogyakarta palace, tropical garden",
    "elegant Balinese woman, Ubud monkey forest, zen atmosphere",
]


def generate_scenic_image(category_english: str, category_indonesian: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("Indonesian", category_english)
    if premade:
        return premade
        ...
        for attempt in range(3):
            ...
            prompt = (
                f"Professional YouTube thumbnail for Indonesian language learning video. "
                f"{style}. "
                ...
                f"At top: '120 INDONESIAN PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY INDONESIAN'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    draw.text((960, 180), "120 INDONESIAN PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
